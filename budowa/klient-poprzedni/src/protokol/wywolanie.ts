 ...
 * strumień i ruch ciągły. Widok pyta jednak punktowo — „wejdź do środowiska
 ...
 * `blad`, więc wywołujący nie musi zakładać `try`, a brak odpowiedzi nie
 * wywraca widoku. Gdy rdzeń nie odpowie w ogóle — bo połączenie
 * padło w trakcie — obietnica po prostu pozostaje nierozstrzygnięta: kontrakt
 * nie przewiduje limitu czasu, a rozłączenie klienta nie kończy pracy rdzenia
 * nad poleceniem.
 */
