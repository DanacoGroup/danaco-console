...
Osiem etapów drogi od uruchomienia do okna operacyjnego. Pliki bez numerów —
kolejność wynika z przepływu, nie z nazwy.
| Plik | Etap | Okno |
|---|---:|---|
| `przeplyw/okno-startowe.html` | 1 | Okno startowe — łączenie z serwerem (trzy warianty stanu) |
| `przeplyw/rejestracja-i-logowanie.html` | 2 | Rejestracja i logowanie — sześć stanów (logowanie, błąd, rejestracja, kod, odzyskiwanie) |
| `przeplyw/przygotowanie-srodowiska.html` | 3 | Przygotowanie środowiska pracy — widok przejściowy po zalogowaniu |
