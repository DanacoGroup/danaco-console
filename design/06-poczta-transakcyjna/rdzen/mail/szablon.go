...
// subjects to wzorce tematów. Tematy listów 1, 2, 4 i 5 zawierają kod —
// rozszerza to powierzchnię wycieku o każdy element trasy zapisujący temat
// (runbook-wdrozenia.md, rozdz. 5.3). Usunięcie kodu to zmiana jednego wiersza.
var subjects = map[Kind]string{
	KindAccountActivation:  "Danaco Console — kod aktywacji konta: {{code}}",
	KindLoginCode:          "Danaco Console — kod logowania: {{code}}",
	KindNoMailbox:          "Adres noreply@danaco-group.pl nie przyjmuje korespondencji",
	KindPasswordReset:      "Danaco Console — kod resetu hasła: {{code}}",
	KindAddressChangeCode:  "Danaco Console — kod potwierdzenia nowego adresu: {{code}}",
