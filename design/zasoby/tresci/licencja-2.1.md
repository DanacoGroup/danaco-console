...
1. [Postanowienia wstępne](#1-postanowienia-wstępne)
   ...
   - [1.6 Sposób oznaczania rozstrzygnięć](#16-sposób-oznaczania-rozstrzygnięć)
...
16. [Załącznik B — wykaz rozstrzygnięć Operatora](#załącznik-b--wykaz-rozstrzygnięć-operatora)
...
**Rozstrzygnięcie (2026-08-26):** Licencjobiorcą jest **podmiot** — osoba
prawna, jednostka organizacyjna albo osoba fizyczna, w tym prowadząca
działalność gospodarczą — któremu Licencjodawca udostępnił Egzemplarz,
**z prawem wskazania Operatorów** w liczbie wynikającej z rozdz. 4.3.
Licencjobiorca odpowiada za działania i zaniechania wskazanych Operatorów jak
za własne. Jeżeli Egzemplarz udostępniono osobie fizycznej bez wskazania
podmiotu, Licencjobiorcą jest ta osoba, a Operatorem — ona sama.
...
3. **dokumentacja produktu** przekazana Licencjobiorcy wraz z Egzemplarzem,
   obejmująca — poza niniejszym plikiem `LICENSE.md` — trzy dokumenty
   oznaczone nazwami plików:
   - **`README.md`** — karta techniczno-produktowa Danaco Console: koncepcja,
     ...
     funkcji;
   - **`INSTRUKCJA-UZYTKOWANIA.md`** — opis pracy z gotową Instalacją: strona
     główna, Środowiska, Okno komunikacji, okna równoległe, okno konfiguracji,
     punkty dostępu, konta i tożsamość modelu;
   - **`INSTALACJA-I-KONFIGURACJA.md`** — procedura instalacji, budowania
...
Niniejszy dokument został przygotowany na podstawie dokumentacji technicznej
i stanu faktycznego repozytorium, a kwestie handlowo-prawne pozostawione
wcześniej do decyzji Operatora zostały rozstrzygnięte i wpisane do treści
(Załącznik B). W tej postaci dokument stanowi **wersję ustaloną**, zdatną do
dołączenia do dystrybucji Wydań o statusie Deweloperskim.

**Przed rozpoczęciem dystrybucji komercyjnej — w szczególności przed
wprowadzeniem odpłatności (rozdz. 4.5) — zaleca się przegląd dokumentu przez
radcę prawnego lub adwokata.** Przegląd powinien objąć w szczególności:
...
- weryfikację rozstrzygnięć Operatora zebranych w Załączniku B pod kątem
  skuteczności w świetle prawa właściwego.

### 1.6 Sposób oznaczania rozstrzygnięć

Kwestie prawne i biznesowe, których dokumentacja projektu nie rozstrzygała,
zostały rozstrzygnięte decyzją Operatora z dnia **2026-08-26** i wpisane do
treści z oznaczeniem **Rozstrzygnięcie (2026-08-26)**. Komplet rozstrzygnięć,
wraz ze wskazaniem przyjętego wariantu, zbiera Załącznik B. Zmiana
któregokolwiek rozstrzygnięcia następuje wyłącznie w trybie rozdz. 8.6 albo
14.3.
...
Instrukcja użytkowania rozdz. 1.4 oraz
Instalacja i konfiguracja, nazywa wyłącznie trzy
...
7. **dokumentację produktu** przekazaną Licencjobiorcy wraz z Egzemplarzem —
   pliki `README.md`, `INSTRUKCJA-UZYTKOWANIA.md`
   i `INSTALACJA-I-KONFIGURACJA.md` wraz z niniejszym plikiem `LICENSE.md`
...
powstania dokumentu: plik `README.md` dostarczany w katalogu produktu jest
...
przez wielu Operatorów jednocześnie określa rozdz. 4.3 akapit ostatni.

**Rozstrzygnięcie (2026-08-26):** przyjmuje się **model mieszany**
dystrybucji: instalator Windows udostępniany wskazanym Licencjobiorcom do
pracy indywidualnej (Rdzeń lokalny) oraz — po odrębnym uzgodnieniu — dostęp
do Rdzenia serwerowego dla pracy zespołowej. Jednostką licencjonowania jest
w obu postaciach **Operator** (rozdz. 4.3).
...
| `README.md` | karta techniczno-produktowa: koncepcja, architektura, stos, zakres funkcjonalny wraz ze stanem wykonania |
| `INSTRUKCJA-UZYTKOWANIA.md` | praca z gotową Instalacją — widoki, Okno komunikacji, konfiguracja, konta i tożsamość modelu |
| `INSTALACJA-I-KONFIGURACJA.md` | instalacja, budowanie warstw, doprowadzenie świeżej Instalacji do pracy, zmienne środowiska i argumenty wywołania |
...
`INSTALACJA-I-KONFIGURACJA.md`, `README.md` i `INSTRUKCJA-UZYTKOWANIA.md`.
...
**Rozstrzygnięcie (2026-08-26):** Licencja jest **licencją imienną,
liczoną według Operatorów**. Jeden uprawniony Operator może korzystać
z Oprogramowania na dowolnej liczbie urządzeń pozostających w dyspozycji
Licencjobiorcy, przy zakazie korzystania równoczesnego przez tę samą osobę na
więcej niż jednym urządzeniu. Liczbę uprawnionych Operatorów określa
uzgodnienie towarzyszące udostępnieniu Egzemplarza (zamówienie, potwierdzenie
udostępnienia albo odrębna umowa); w braku takiego uzgodnienia liczba
uprawnionych Operatorów wynosi **jeden**. W topologii z Rdzeniem serwerowym
jednostką liczenia pozostaje Operator: jedna Instalacja Rdzenia może
obsługiwać wyłącznie Operatorów mieszczących się w uzgodnionej liczbie.
...
**Rozstrzygnięcie (2026-08-26):** Licencja na Wydania o statusie
**Deweloperskim jest nieodpłatna**. Odpłatność — wraz z modelem rozliczeń,
zasadami fakturowania i skutkami opóźnienia w zapłacie — zostanie
wprowadzona najwcześniej wraz z pierwszym Wydaniem o statusie innym niż
Deweloperski, nową wersją dokumentu Licencji w trybie rozdz. 8.6.
Nieodpłatność fazy Deweloperskiej nie stanowi zrzeczenia się prawa do
wynagrodzenia za Wydania przyszłe.
...
8. odwzorowywać chronionych elementów Oprogramowania wskazanych
   w rozdz. 6.1 — w szczególności Kontraktu, modelu danych i warstwy
   wizualnej — w produkcie własnym albo osoby trzeciej; zakaz ten nie
   obejmuje tworzenia produktów tej samej kategorii bez wykorzystania
   elementów chronionych;
9. przeprowadzać testów penetracyjnych, testów obciążeniowych ani badań
   bezpieczeństwa **cudzych instalacji** Oprogramowania; badania we własnym
   środowisku Licencjobiorcy są dozwolone, a ustalone podatności podlegają
   zgłoszeniu wyłącznie Licencjodawcy w trybie rozdz. 13.4.

**Rozstrzygnięcie (2026-08-26) do pkt 8:** przyjęto **zakaz wąski** —
ochronie podlega odwzorowanie chronionych elementów wskazanych w rozdz. 6.1;
tworzenie produktów tej samej kategorii bez wykorzystania tych elementów nie
jest ograniczone. **Rozstrzygnięcie do pkt 9:** badania bezpieczeństwa
i testy obciążeniowe **we własnym środowisku Licencjobiorcy są dozwolone**;
zakaz obejmuje wyłącznie badanie cudzych instalacji, a ustalenia podlegają
zgłoszeniu w trybie rozdz. 13.4. Rozstrzygnięcie usuwa sprzeczność między
zakazem badań a obowiązkiem zgłaszania podatności.
...
**Rozstrzygnięcie (2026-08-26):** Licencja **nie przewiduje kar umownych**.
Odpowiedzialność za naruszenie ograniczeń kształtują zasady ogólne prawa
właściwego oraz uprawnienie do wypowiedzenia z rozdz. 11.3. Rozstrzygnięcie
odpowiada nieodpłatnemu charakterowi fazy Deweloperskiej (rozdz. 4.5) i może
ulec zmianie wraz z wprowadzeniem odpłatności, w trybie rozdz. 8.6.
...
**Rozstrzygnięcie (2026-08-26):** do czasu ewentualnej rejestracji znaków
oznaczenia „Danaco Console” oraz oznaczenia graficzne produktu podlegają
ochronie jako **oznaczenia nierejestrowane** — na podstawie prawa autorskiego
do logotypów, przepisów o zwalczaniu nieuczciwej konkurencji oraz ochrony
firmy Licencjodawcy. Uzyskanie praw ochronnych na znaki zostanie
odzwierciedlone w kolejnej wersji dokumentu numerami praw, w trybie
rozdz. 8.6, bez zmiany zakresu zobowiązań Licencjobiorcy.
...
**Rozstrzygnięcie (2026-08-26):** przekazując Licencjodawcy uwagi,
zgłoszenia błędów albo propozycje funkcji („**Informacje zwrotne**”),
Licencjobiorca udziela Licencjodawcy nieodpłatnej, niewyłącznej,
nieograniczonej czasowo ani terytorialnie licencji na korzystanie
z Informacji zwrotnych w celu rozwoju, poprawy i utrzymania Oprogramowania,
bez obowiązku wskazywania źródła. Przekazanie Informacji zwrotnych jest
dobrowolne; Licencjobiorca nie przekazuje w tym trybie treści, do których
prawa przysługują osobom trzecim, ani rozwiązań, które zamierza zastrzec —
w takim wypadku zakres korzystania wymaga odrębnego uzgodnienia.
...
**Rozstrzygnięcie (2026-08-26):** inwentarz licencji Komponentów jest
**generowany automatycznie przy każdym Wydaniu** narzędziem inwentaryzującym
uruchamianym na maszynie budującej i dołączany do Wydania jako plik `NOTICE`.
Zestawienie Załącznika A dokumentuje stan na dzień wydania niniejszej wersji
Licencji; w razie rozbieżności między Załącznikiem A a plikiem `NOTICE`
Wydania rozstrzyga plik `NOTICE` jako zestawienie generowane z rzeczywistego
stanu zależności.
...
Redakcja niniejszej Licencji zweryfikowała bezpośrednio treść `README.md`
i `INSTRUKCJA-UZYTKOWANIA.md` dołączonych do Egzemplarza: oba dokumenty
...
(niniejsza Licencja, `README.md`, `INSTRUKCJA-UZYTKOWANIA.md`) zgodnie
...
**Rozstrzygnięcie (2026-08-26):** do czasu udostępnienia mechanizmu
rozszerzeń wraz z odrębnymi zasadami ich licencjonowania rozszerzenia mogą
pochodzić **wyłącznie od Licencjodawcy**, a instalowanie w Oprogramowaniu
komponentów rozszerzających pochodzących od osób trzecich pozostaje
niedozwolone na podstawie rozdz. 5.2 pkt 5. Zasady dotyczące rozszerzeń osób
trzecich — w tym licencja API, odpowiedzialność za rozszerzenie i tryb
weryfikacji — zostaną wprowadzone nową wersją dokumentu w trybie rozdz. 8.6
przed udostępnieniem mechanizmu.
...
**Rozstrzygnięcie (2026-08-26):** w okresie statusu Deweloperskiego
Aktualizacje udostępnione przez Licencjodawcę wchodzą w zakres Licencji
**nieodpłatnie**, przy czym Licencjodawca **nie zobowiązuje się** do ich
wydawania, do utrzymywania Wydań wcześniejszych ani do usuwania podatności
w oznaczonym terminie (rozdz. 8.5). Wsparcie techniczne świadczone jest
w miarę możliwości, drogą poczty elektronicznej na adres wskazany
w rozdz. 14.7, bez gwarantowanych czasów reakcji. Zobowiązania serwisowe
mogą zostać wprowadzone wraz z odpłatnością (rozdz. 4.5), nową wersją
dokumentu w trybie rozdz. 8.6.

### 8.5 Brak zobowiązania do rozwoju

Licencjodawca **nie zaciąga zobowiązania** do wydawania Aktualizacji,
rozwijania Oprogramowania, doprowadzania do stanu działającego funkcji
przewidzianych koncepcją ani do świadczenia wsparcia technicznego
wykraczającego poza zakres opisany w rozdz. 8.4. Postanowienie to jest
bezpośrednią konsekwencją statusu Deweloperskiego i nieodpłatnego charakteru
udostępnienia w tej fazie (rozdz. 4.5); może ulec zmianie wraz
z wprowadzeniem odpłatności, w trybie rozdz. 8.6.
...
**Rozstrzygnięcie (2026-08-26):** postanowienia rozdz. 9.6 dotyczą
instalacji z **Rdzeniem lokalnym**. Uruchomienie topologii z Rdzeniem
serwerowym prowadzonym przez Licencjodawcę albo podmiot z nim powiązany
wymaga — **przed rozpoczęciem przetwarzania** — zawarcia odrębnej umowy
obejmującej powierzenie przetwarzania danych osobowych w rozumieniu art. 28
RODO, wraz z określeniem prowadzącego serwer, lokalizacji przetwarzania,
okresu retencji i zasad usuwania danych. Do czasu zawarcia takiej umowy
udostępnienie Rdzenia serwerowego danemu Licencjobiorcy nie następuje.
...
4. **Okna operacyjne modułów nie istnieją** — z siedemdziesięciu dziewięciu wierszy
   ...
   dokumentacji produktu (`INSTRUKCJA-UZYTKOWANIA.md`
...
**Rozstrzygnięcie (2026-08-26):** w okresie nieodpłatnego udostępniania
(rozdz. 4.5) odpowiedzialność Licencjodawcy jest ograniczona do szkody
wyrządzonej **z winy umyślnej**, w najszerszym zakresie dopuszczalnym przez
prawo właściwe. Z chwilą wprowadzenia odpłatności limit odpowiedzialności
zostanie oznaczony jako równowartość wynagrodzenia zapłaconego przez
Licencjobiorcę w okresie dwunastu miesięcy poprzedzających zdarzenie
szkodzące, nową wersją dokumentu w trybie rozdz. 8.6. Ograniczenia nie
uchybiają odpowiedzialności, której wyłączyć nie można na podstawie przepisu
...
**Rozstrzygnięcie (2026-08-26):** Licencja na **Wydanie posiadane** przez
Licencjobiorcę jest udzielana **bezterminowo**, z zastrzeżeniem uprawnień do
wypowiedzenia z rozdz. 11.3. Uprawnienie do Aktualizacji reguluje odrębnie
rozdz. 8.4; wygaśnięcie albo zmiana tego uprawnienia nie pozbawia
Licencjobiorcy prawa do korzystania z Wydania już posiadanego.
...
1. **Wypowiedzenie przez Licencjobiorcę.** Licencjobiorca może w każdym czasie
   ...
   świadczeń; przy nieodpłatnej Licencji fazy Deweloperskiej (rozdz. 4.5)
   świadczenia podlegające zwrotowi nie powstają.
2. **Wypowiedzenie przez Licencjodawcę z przyczyny naruszenia.** Licencjodawca
   ...
   elektroniczną. **Rozstrzygnięcie (2026-08-26):** termin ten wynosi
   **trzydzieści dni** dla naruszeń usuwalnych (w szczególności przekroczenia
   liczby Operatorów albo braku ewidencji); przy naruszeniach nieusuwalnych —
   w szczególności rozpowszechnieniu Oprogramowania albo obejściu oznaczeń —
   wypowiedzenie może nastąpić **bez wyznaczania terminu**.
3. **Wypowiedzenie bez przyczyny.** Wobec bezterminowego charakteru Licencji
   na Wydanie posiadane (rozdz. 11.2) Licencjodawcy **nie przysługuje**
   uprawnienie do wypowiedzenia Licencji bez wskazania przyczyny w odniesieniu
   do Wydania już posiadanego przez Licencjobiorcę; nie ogranicza to swobody
   Licencjodawcy co do udostępniania Wydań przyszłych.
...
korzystania z tym zakresem. Przedmiotem ewidencji — stosownie do
rozstrzygnięcia rozdz. 4.3 — jest wykaz uprawnionych Operatorów oraz
Instalacji, z których korzystają. Obowiązek ewidencyjny z rozdz. 4.3 pkt 1
i obowiązek niniejszy są jednym i tym samym obowiązkiem opisanym w dwóch
miejscach dokumentu ze względu na układ rozdziałów.

### 12.2 Weryfikacja

**Rozstrzygnięcie (2026-08-26):** Licencjodawca może żądać od
Licencjobiorcy **oświadczenia o liczbie Instalacji i uprawnionych
Operatorów**, składanego w postaci dokumentowej, nie częściej niż **raz
w roku kalendarzowym**. Licencjodawcy nie przysługuje prawo audytu
w siedzibie Licencjobiorcy ani dostęp do treści zapisanych w Bazie.
...
**trzy lata** po jej zakończeniu (**Rozstrzygnięcie 2026-08-26**),
a w odniesieniu do informacji stanowiących tajemnicę przedsiębiorstwa: przez
cały okres, w którym zachowują one taki charakter. Ta druga część
zobowiązania nie jest ograniczona terminem.
...
**Rozstrzygnięcie (2026-08-26):** zgłoszenia podatności kieruje się na
adres poczty elektronicznej **security@danaco-group.pl**. Strony stosują
zasadę skoordynowanego ujawniania: Licencjobiorca powstrzymuje się od
publikacji przez okres uzgodniony z Licencjodawcą, nie dłuższy niż
**dziewięćdziesiąt dni** od zgłoszenia, chyba że poprawka zostanie wydana
wcześniej albo strony uzgodnią inaczej.
...
**Rozstrzygnięcie (2026-08-26):** prawem właściwym dla Licencji jest
**prawo polskie**, z wyłączeniem norm kolizyjnych. Jeżeli Licencjobiorcą jest
konsument, wybór prawa nie pozbawia go ochrony przyznanej przepisami
bezwzględnie obowiązującymi państwa jego zwykłego pobytu.

### 14.2 Rozstrzyganie sporów

**Rozstrzygnięcie (2026-08-26):** spory wynikłe z Licencji rozstrzyga
**sąd powszechny właściwy miejscowo dla siedziby Licencjodawcy**. Zastrzeżenie
to nie wiąże Licencjobiorcy będącego konsumentem — w sporach z konsumentem
właściwość sądu ustala się według przepisów ogólnych.
...
**Rozstrzygnięcie (2026-08-26):** dane kontaktowe Licencjodawcy:

| | |
|---|---|
| **Licencjodawca** | Danaco Holding Group Sp. z o.o. |
| **Adres siedziby** | *[do uzupełnienia danymi rejestrowymi]* |
| **KRS / NIP** | *[do uzupełnienia danymi rejestrowymi]* |
| **Korespondencja i wsparcie** | support@danaco-group.pl |
| **Zgłoszenia podatności** | security@danaco-group.pl (rozdz. 13.4) |

Uzupełnienie pól rejestrowych następuje przed dystrybucją zewnętrzną i nie
stanowi zmiany Licencji w rozumieniu rozdz. 14.3.
...
marki z poz. 4. `README.md` i `INSTRUKCJA-UZYTKOWANIA.md` posługują się zgodnie
...
## Załącznik B — wykaz rozstrzygnięć Operatora

Kwestie wymienione poniżej były we wcześniejszej redakcji dokumentu
pozostawione do decyzji Operatora. Zostały rozstrzygnięte decyzją Operatora
z dnia **2026-08-26** i wpisane do treści rozdziałów wskazanych w tabeli.
W razie rozbieżności między tabelą a treścią rozdziału rozstrzyga treść
rozdziału (rozdz. 14.8).

| Lp. | Rozdział | Kwestia | Rozstrzygnięcie |
|---|---|---|---|
| 1 | 1.2 | Definicja Licencjobiorcy | podmiot (w tym osoba fizyczna) z prawem wskazania Operatorów |
| 2 | 3.2 | Model dystrybucji końcowej | model mieszany: instalator lokalny + Rdzeń serwerowy po odrębnym uzgodnieniu; jednostka: Operator |
| 3 | 4.3 | Liczba stanowisk i jednostka liczenia | licencja imienna per Operator; wiele urządzeń, zakaz korzystania równoczesnego; domyślnie 1 Operator |
| 4 | 4.5 | Odpłatność | nieodpłatna dla statusu Deweloperskiego; odpłatność od pierwszego Wydania produkcyjnego, w trybie rozdz. 8.6 |
| 5 | 5.2 pkt 8 | Zakaz budowy produktu konkurencyjnego | zakaz wąski — wyłącznie odwzorowanie elementów chronionych z rozdz. 6.1 |
| 6 | 5.2 pkt 9 | Badania bezpieczeństwa | dozwolone we własnym środowisku; zakaz badania cudzych instalacji; zgłoszenia trybem rozdz. 13.4 |
| 7 | 5.8 | Kary umowne | brak kar umownych; zasady ogólne |
| 8 | 6.4 | Status ochronny znaków | ochrona oznaczeń nierejestrowanych; rejestracja odzwierciedlana w trybie rozdz. 8.6 |
| 9 | 6.6 | Informacje zwrotne | nieodpłatna, niewyłączna licencja dla Licencjodawcy na korzystanie w celu rozwoju produktu |
| 10 | 7.4 | Inwentarz licencji Komponentów | plik `NOTICE` generowany automatycznie przy każdym Wydaniu; rozstrzyga `NOTICE` |
| 11 | 7.8 | Rozszerzenia | wyłącznie od Licencjodawcy; rozszerzenia osób trzecich niedozwolone do odrębnej regulacji |
| 12 | 8.4 | Aktualizacje i wsparcie | Aktualizacje w ramach Licencji nieodpłatnie, bez zobowiązania do wydawania; wsparcie e-mail bez czasów reakcji |
| 13 | 9.6 | Role RODO przy Rdzeniu serwerowym | rozdz. 9.6 dotyczy Rdzenia lokalnego; topologia serwerowa wymaga uprzedniej umowy powierzenia (art. 28 RODO) |
| 14 | 10.4 | Górna granica odpowiedzialności | w fazie nieodpłatnej: wina umyślna; po wprowadzeniu odpłatności: limit 12-miesięcznego wynagrodzenia |
| 15 | 11.2 | Okres obowiązywania | licencja bezterminowa na Wydanie posiadane; Aktualizacje odrębnie (rozdz. 8.4) |
| 16 | 11.3 pkt 2 | Termin usunięcia naruszenia | 30 dni dla naruszeń usuwalnych; bez terminu dla nieusuwalnych |
| 17 | 12.2 | Kontrola zgodności | oświadczenie o liczbie Instalacji i Operatorów, nie częściej niż raz w roku; bez audytu i dostępu do Bazy |
| 18 | 13.3 | Okres poufności następczej | trzy lata; tajemnica przedsiębiorstwa bez terminu |
| 19 | 13.4 | Kanał zgłaszania podatności | security@danaco-group.pl; skoordynowane ujawnianie do 90 dni |
| 20 | 14.1 | Prawo właściwe | prawo polskie, z zachowaniem bezwzględnej ochrony konsumenta |
| 21 | 14.2 | Właściwość sądu | sąd siedziby Licencjodawcy; wobec konsumentów — przepisy ogólne |
| 22 | 14.7 | Dane identyfikacyjne Licencjodawcy | wpisane adresy e-mail; pola rejestrowe (adres, KRS, NIP) do uzupełnienia przed dystrybucją zewnętrzną |
| 23 | 1.5 | Przegląd prawny | wersja ustalona dla fazy Deweloperskiej; przegląd prawny zalecany przed dystrybucją komercyjną |
...
Pozycja została usunięta po weryfikacji bezpośredniej treści `README.md`
i `INSTRUKCJA-UZYTKOWANIA.md`, która wykazała, że oba dokumenty posługują się
...
**Uwaga o czterech pozycjach: poz. 5, 6, 16 i 18.** Pozycje te we
wcześniejszej redakcji dokumentu zawierały wartości przyjęte bez oznaczenia
(odpowiednio: zakaz konkurencji, zakaz badań bezpieczeństwa, termin
czternastu dni, pięcioletni okres poufności), następnie oznaczone jako
wymagające decyzji. Rozstrzygnięcia z dnia 2026-08-26 zastępują te wartości:
zakaz wąski, badania własnego środowiska dozwolone, termin trzydziestu dni
dla naruszeń usuwalnych, trzyletni okres poufności następczej.
...
3. dokumentacji technicznej towarzyszącej kodowi (kontrakt komunikacyjny —
   Kontrakty komunikacji; model danych —
   Model danych; mechanizm izolacji —
   Izolacja i zależności; katalog modułów
   i środowisk — `moduly/`, `srodowiska/`; katalog okien operacyjnych w bazie
   i wykaz luk — rozdz. 18 i 20 `README.md`);
...
| Nazwy plików dokumentacji produktu | zawartość katalogu produktu; wykaz dokumentów w `README.md` |
...
5. Twierdzenia o zgodności niniejszego dokumentu z pozostałymi dokumentami
   ...
   `README.md` ani `INSTRUKCJA-UZYTKOWANIA.md` na dzień tej weryfikacji — oba
...
**Niniejszy dokument stanowi wersję ustaloną: rozstrzygnięcia Operatora
z dnia 2026-08-26 zostały wpisane do treści (Załącznik B). Przed dystrybucją
komercyjną zalecany jest przegląd prawny (rozdz. 1.5); przed dystrybucją
zewnętrzną wymagane jest uzupełnienie pól rejestrowych w rozdz. 14.7.**

---

*Koniec dokumentu. Licencja produktu — Akt prawny, wersja 2.1, 2026-08-26.*
